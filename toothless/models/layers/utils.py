...
class RotaryPositionalEncoding(nn.Module):
    ...
    def forward(self, t: Tensor, k: Tensor, start_pos: int = 0) -> Tensor:
        """
        ...
        self._compute_cos_sin_cache(cache_len, t.device, t.dtype)
        ...
        cos = cos[None, :, :].expand_as(t[..., ::2])
        sin = sin[None, :, :].expand_as(t[..., ::2])

        # Apply rotary embedding
        return self._apply_rotary_pos_emb(t, cos, sin)
